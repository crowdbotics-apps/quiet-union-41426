"""
Django settings for quiet_union_41426 project.
...
ROOT_URLCONF = 'quiet_union_41426.urls'
...
WSGI_APPLICATION = 'quiet_union_41426.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_union_41426 API",
    "DESCRIPTION": "API documentation for quiet_union_41426 App",
    "VERSION": "v1",
}
